        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                if len(outputs) > 0:
                    ...
                    speeds = draw_boxes(im0, bbox_xyxy, frame_idx, myclassesyo, identities)
                    ...
                    if save_txt:
                        for j, (tlwh_bbox, output, speed) in enumerate(zip(tlwh_bboxs, outputs, speeds)):
                            ...
                            with open(txt_path, 'a') as f:
                                f.write(('%g ' * 8 + '\n') % (frame_idx, identity, bbox_top,
                                                               bbox_left, bbox_w, bbox_h, class_id, speed
                                                               ))  # label format
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weights', type=str, default='models/best_yolov5s_aihub_finetune.pt', help='model.pt path')
    parser.add_argument('--deep_sort_weights', type=str, default='models/ckpt.t7',
                        help='ckpt.t7 path')
